...
const Technology = ({technologies}) => {
    ...
    return (
        <div className=" grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            className="flex h-[380px] flex-col rounded-2xl border border-gray-200 bg-white p-7  "
          ...
          >
            ...
            <button className="mt-6 w-full text-[12px] rounded-lg bg-[#0A0F1D] py-3 font-semibold text-white transition hover:bg-[#1E293B]">
